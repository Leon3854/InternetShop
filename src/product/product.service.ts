...
export class ProductService {
  ...
  async create(dot: ProductDto) {
    const { description, name, images, price, categoryId } = dot
    await this.categoryService.byId(categoryId) // Убедитесь, что категория существует
  ...
  async update(id: number, dot: ProductDto) {
    const { description, name, images, price, categoryId } = dot
